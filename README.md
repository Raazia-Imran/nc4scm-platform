...
Open the Studio, create at least one document of each type (Team Member,
Partner, Service, Publication, Event, News) and publish them — the frontend
will show empty-state messages until real content exists.
