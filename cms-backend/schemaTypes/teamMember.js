  ...
  fields: [
    {
      ...
      title: 'Full Name',
      type: 'string',
      validation: (Rule) => Rule.required().error('A team member must have a full name.'),
    },
    {
      name: 'slug',
      title: 'Slug',
      type: 'slug',
      description: 'Auto-generated URL-safe identifier, derived from the full name.',
    ...
    },
    {
      ...
      type: 'number',
      description: 'Lower numbers are shown first in the Team Directory grid (e.g. 1 = shown first).',
