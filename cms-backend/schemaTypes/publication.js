...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      options: {
        list: [
          ...
          {title: 'Material Characterization', value: 'material-characterization'},
          {title: 'New Material Development', value: 'new-material-development'},
    ...
    },
    {
      ...
      validation: (Rule) => Rule.min(1).error('At least one author must be linked.'),
    },
    {
      name: 'abstract',
      title: 'Abstract',
